...
describe('AuditService', () => {
  ...
  describe('getAuditStats', () => {
    beforeEach(async () => {
      await AuditLog.create([
        { entityType: 'config', entityId: '1', tenantId: 'tenantA', action: 'CREATE' },
        { entityType: 'config', entityId: '2', tenantId: 'tenantA', action: 'CREATE' },
        { entityType: 'config', entityId: '3', tenantId: 'tenantA', action: 'UPDATE' },
        { entityType: 'config', entityId: '4', tenantId: 'tenantA', action: 'ARCHIVE' },
      ]);
    });
